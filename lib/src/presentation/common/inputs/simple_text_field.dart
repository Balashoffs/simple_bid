  ...
  void initState() {
    ...
    if (widget.initialValue != null) {
      _controller.value = TextEditingValue(
          ...
          selection: TextSelection(baseOffset: widget.initialValue!.length, extentOffset: widget.initialValue!.length));
    }
        ...
        ConstrainedBox(
          ...
          child: TextFormField(
            ...
            onChanged: (text) {
              ...
              if (widget.changeAfterSubmit) return;
